...
/**
 * @extends ServiceEntityRepository<RebateGoodsData>
 */
#[AsRepository(entityClass: RebateGoodsData::class)]
class RebateGoodsDataRepository extends ServiceEntityRepository
{
    ...
    public function save(RebateGoodsData $entity, bool $flush = true): void
    {
    ...
    public function remove(RebateGoodsData $entity, bool $flush = true): void
    {
