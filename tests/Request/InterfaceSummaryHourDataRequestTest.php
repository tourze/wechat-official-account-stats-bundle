 ...
 * @internal
 */
#[CoversClass(InterfaceSummaryHourDataRequest::class)]
#[RunTestsInSeparateProcesses]
final class InterfaceSummaryHourDataRequestTest extends AbstractIntegrationTestCase
{
    private InterfaceSummaryHourDataRequest $request;

    protected function onSetUp(): void
    {
        $this->request = $this->createMock(InterfaceSummaryHourDataRequest::class);
    }
    ...
    public function testGetRequestPathReturnsCorrectPath(): void
    {
        $this->request->method('getRequestPath')
            ->willReturn('https://api.weixin.qq.com/datacube/getinterfacesummaryhour')
        ;
