 ...
 * @internal
 */
#[CoversClass(GetArticleTotalRequest::class)]
#[RunTestsInSeparateProcesses]
final class GetArticleTotalRequestTest extends AbstractIntegrationTestCase
{
    private GetArticleTotalRequest $request;

    protected function onSetUp(): void
    {
        $this->request = $this->createMock(GetArticleTotalRequest::class);
    }
    ...
    public function testGetRequestPathReturnsCorrectPath(): void
    {
        $this->request->method('getRequestPath')
            ->willReturn('https://api.weixin.qq.com/datacube/getarticletotal')
        ;
