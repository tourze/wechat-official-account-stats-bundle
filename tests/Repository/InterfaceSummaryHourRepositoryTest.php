 ...
 * @internal
 */
#[CoversClass(InterfaceSummaryHourRepository::class)]
#[RunTestsInSeparateProcesses]
final class InterfaceSummaryHourRepositoryTest extends AbstractRepositoryTestCase
{
    private InterfaceSummaryHourRepository $repository;

    public function testCanBeInstantiated(): void
    {
        $this->assertInstanceOf(InterfaceSummaryHourRepository::class, $this->repository);
    }

    public function testSave(): void
    {
        $account = $this->createAccount();
        $entity = new InterfaceSummaryHour();
        ...
        $this->assertInstanceOf(InterfaceSummaryHour::class, $found);
    ...
    {
        $this->repository = self::getService(InterfaceSummaryHourRepository::class);
    }
    ...
    /**
     * @return ServiceEntityRepository<InterfaceSummaryHour>
     */
