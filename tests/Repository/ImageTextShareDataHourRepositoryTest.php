...
class ImageTextShareDataHourRepositoryTest extends TestCase
{
    /**
    ...
    public function testRepositoryConstruction(): void
    {
        ...
        // 测试能否正确实例化仓库
        $repository = new ImageTextShareDataHourRepository($registry);

        $this->assertInstanceOf(ImageTextShareDataHourRepository::class, $repository);
    }
    ...
    {
        // 验证实体类名被正确传递给父类构造函数
        $constructorBody = $this->getConstructorBody(ImageTextShareDataHourRepository::class);
        $this->assertStringContainsString('ImageTextShareDataHour::class', $constructorBody, '构造函数应传递 ImageTextShareDataHour::class 给父类');
    }
