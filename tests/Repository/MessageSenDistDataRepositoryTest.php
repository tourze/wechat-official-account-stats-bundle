 ...
 * @internal
 */
#[CoversClass(MessageSenDistDataRepository::class)]
#[RunTestsInSeparateProcesses]
final class MessageSenDistDataRepositoryTest extends AbstractRepositoryTestCase
{
    private MessageSenDistDataRepository $repository;

    public function testCanBeInstantiated(): void
    {
        $this->assertInstanceOf(MessageSenDistDataRepository::class, $this->repository);
    }

    public function testSave(): void
    {
        $account = $this->createAccount();
        $entity = new MessageSenDistData();
        $entity->setAccount($account);
        $entity->setDate(new \DateTimeImmutable());
        $entity->setCountInterval(MessageSendDataCountIntervalEnum::ZERO);

        $this->repository->save($entity, true);

        $this->assertNotNull($entity->getId());
        $found = $this->repository->find($entity->getId());
        $this->assertInstanceOf(MessageSenDistData::class, $found);
    ...
    {
        $this->repository = self::getService(MessageSenDistDataRepository::class);
    }
    ...
    /**
     * @return ServiceEntityRepository<MessageSenDistData>
     */
