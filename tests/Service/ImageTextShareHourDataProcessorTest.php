 ...
 * @internal
 */
#[CoversClass(ImageTextShareHourDataProcessor::class)]
final class ImageTextShareHourDataProcessorTest extends TestCase
{
    private ImageTextShareDataHourRepository&MockObject $repository;

    private LoggerInterface&MockObject $logger;

    private EntityManagerInterface&MockObject $entityManager;

    private ImageTextShareHourDataProcessor $processor;

    protected function setUp(): void
    {
        $this->repository = $this->createMock(ImageTextShareDataHourRepository::class);
        $this->logger = $this->createMock(LoggerInterface::class);
        $this->entityManager = $this->createMock(EntityManagerInterface::class);

        $this->processor = new ImageTextShareHourDataProcessor(
            $this->repository,
            $this->logger,
            $this->entityManager,
        );
    ...
    {
        $this->assertInstanceOf(ImageTextShareHourDataProcessor::class, $this->processor);
    }
